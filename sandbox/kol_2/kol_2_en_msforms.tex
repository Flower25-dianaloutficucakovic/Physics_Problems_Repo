...
\begin{tikzpicture}[line width=0.8pt, x=1cm, y=1cm]
  ...
  \coordinate (P3out) at (7.45,0);
  \draw (P3) -- (P3out);
  \draw (P3out) -- ++(0,1.05) -- (R4a.west);
  \draw (P3out) -- ++(0,0.35) -- (R4b.west);
  \draw (P3out) -- ++(0,-0.35) -- (R4c.west);
  \draw (P3out) -- ++(0,-1.05) -- (R4d.west);
  \draw (R4a.east) -| (P4);
  \draw (R4b.east) -| (P4);
  \draw (R4c.east) -| (P4);
  \draw (R4d.east) -| (P4);
